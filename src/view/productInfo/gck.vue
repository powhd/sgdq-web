      ...
      <section class="section">
        <div class="modular-section">
         ...
         <div class="image-placeholder">
            <img style="width: 100%;" src="@/assets/img/p4.png" alt="SIVACON 8PT">
          </div>
      </section>
    </main>
  </div>
    ...
    return {
      ...
      sections: {
        intro: {
          ...
          paragraphsEn: [
            `GCK low-voltage draw-out switchgear is applicable to three-phase fourwire and three-phase five-wire power systems with three-phase AC 50, 
60Hz, rated voltage 660V and rated current 4,000A and below and is used 
to accept and distribute electric energy. It has been widely applied to power 
distribution center PC and motor control center MCC of power plants, 
substations, industrial and mining enterprises and high-rise buildings.`
          ]
        },
        modular: {
          titleCn: '符合标准',
...
。GB7251.1 低压成套开关设备和控制设备 第一部分:总则,GB7251.12 低压成套开关设备和控制设备 第二部分:成套电力开关和控制设备。IEC61439 《低压成套开关设备和控制设备》`
          ],
          paragraphsEn: [
