      ...
      <section class="section">
        ...
        >
          {{ para }}
            ...
            <img style="width: 100%;" src="@/assets/img/p6.png" alt="SIVACON 8PT">
          </div>
      </section>
...
export default {
  ...
  data() {
    return {
      product: {
        name: 'KYN28A-12',
        subtitleCn: '户内交流金属铠装中置移开式开关设备',
        subtitleEn: 'Indoor AC Metal-Clad Withdrawable Switchgear'
      },
      sections: {
        intro: {
          titleCn: '产品介绍',
          ...
          paragraphsCn: [
            `KYN28A-12型户内交流金属铠装中置移开式开关设备(以下简称开关设备)，3.6~12kV 三相交流 50Hz单母线及单母线分段系统的成套配电装置。主要用于发电厂、中小型发电机送电、工矿企事业配电以及电业系统的二次变电所的受电，送电及大型高压电动机起动等。实行控制保护、检测之用。本开关柜满足 IEC62271、GB3906等标准要求具有防止带负荷推拉断路器手车、防止误分合断路器、防止接地开关处在闭合位置时关合电路器、防止误入带电隔室、防止在带电时误合接地开关的联锁功能，既可配用 ABB 公司的 VD4 型真空断路器，也可配置 VS1 型真空断路器、隔离手车、电压互感器手车等,实为一种性能优越的配电装置。`
          ],
          paragraphsEn: [
            `The KYN28A-12 indoor AC metal-clad withdrawable switchgear (hereinafter referred to as switchgear) is a complete set of power 
distribution devices of 3.6kV ~ 12kV three-phase AC 50Hz single bus or single bus sectional system. The switchgear is mainly 
...
energized state. The switchgear can be used in conjunction with the VD4 circuit breaker of the ABB company, VS1 circuit breaker, 
